...
public class TestReleaseMutation {
    ...
    public void testRelease() throws Exception {
        ...
        basicLocationMap.put("STAN-001", new BasicLocation("STO-1", "Box 1", new Address(1,2), 4, 0));
        basicLocationMap.put("STAN-002", new BasicLocation("STO-1", "Box 1", new Address(3,4), null, 0));
