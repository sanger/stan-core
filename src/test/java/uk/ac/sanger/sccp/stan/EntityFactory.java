...
public class EntityFactory {
    ...
    public static Work[] makeWorks(String... workNumbers) {
        ...
        return Arrays.stream(workNumbers)
                .map(wn -> new Work(++idCounter, wn, wts, null, proj, prog, cc, status))
                .toArray(Work[]::new);
    }
