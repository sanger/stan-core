    ...
    static Stream<ValidateTissueTestData> validateTissuesArgs() {
        ...
        return Stream.of(
                ...
                testData.get()
                        ...
                        .content("EXT2", "5", "Leg", 2, "Donor1", "butter", "Formalin", "2021/02", "human", "tissue")
                        .content("EXT3", "5", "Leg", 1, "Donor2", "butter", "Formalin", null, "hamster", "tissue")
                        .tissues(new Tissue(null, "EXT1", "4", ARM.getSpatialLocations().get(0), DONOR1, mediumNone, fixNone, cellClass, hmdmc1, null, null),
                                new Tissue(null, "EXT2", "5", LEG.getSpatialLocations().get(1), DONOR1, medium, fix, cellClass, hmdmc2, null, null),
