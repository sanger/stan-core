...
public class OpWithSlotMeasurementsServiceImp implements OpWithSlotMeasurementsService {
    public static final String OP_CDNA_AMP = "cDNA amplification", OP_CDNA_ANALYSIS = "cDNA concentration",
            OP_LIBRARY_CONC = "Library concentration";
    ...
    public String sanitiseMeasurementName(OperationType opType, String name) {
        ...
        } else if (opType.getName().equalsIgnoreCase(OP_LIBRARY_CONC)) {
