    ...
    private RuntimeWiring buildWiring() {
        return RuntimeWiring.newRuntimeWiring()
                .type(newTypeWiring("Query")
                        ...
                        .dataFetcher("solutionSamples", graphQLDataFetchers.getSolutionSamples())
                ...
                .type(newTypeWiring("Mutation")
                        ...
                        .dataFetcher("addSolutionSample", transact(graphQLMutation.addSolutionSample()))
                        .dataFetcher("setSolutionSampleEnabled", transact(graphQLMutation.setSolutionSampleEnabled()))
